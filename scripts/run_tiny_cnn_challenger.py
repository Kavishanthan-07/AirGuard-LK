...
print("=" * 100)
print("AIRGUARD-LK — TINY 1D CNN DEVELOPMENT CHALLENGER")
print("=" * 100)
...
ranking_df.to_csv(
    METRIC_DIR
    / "tiny_cnn_development_ranking.csv",
    index=False,
)
...
operational_df.to_csv(
    METRIC_DIR
    / "tiny_cnn_development_operational.csv",
    index=False,
)
...
predictions_df.to_parquet(
    METRIC_DIR
    / "tiny_cnn_development_predictions.parquet",
    index=False,
)
...
ranking_scoreboard.to_csv(
    TABLE_DIR
    / "tiny_cnn_ranking_scoreboard.csv",
    index=False,
)
...
operational_scoreboard.to_csv(
    TABLE_DIR
    / "tiny_cnn_operational_scoreboard.csv",
    index=False,
)
